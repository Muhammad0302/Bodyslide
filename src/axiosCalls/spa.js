...
export const getSpaForumIndividual = async (
	id,
	firstForumIndex,
	forumtPerPage
) => {
...
export const getAllSpaForum = async (firstForumIndex, forumtPerPage) => {
	...
	try {
		res = axiosInstance.get(
			`/api/getspamasseuseforum/${firstForumIndex}/${forumtPerPage}/SpaForum`
		);
	} catch (error) {
		console.log(error);
	}
...
export const deleteSpaForumComment = async (id, forumID, typeForum) => {
	...
	try {
		res = axiosInstance.delete(
			`/api/comment/spa/${id}/${forumID}/${typeForum}`
		);
	} catch (error) {
		console.log(error);
	}
...
export const getSpaMasseuse = async (firstForumIndex, forumtPerPage) => {
	try {
		...
		return await axiosInstance.get(
			`/api/getforums/${firstForumIndex}/${forumtPerPage}`
		);
	} catch (error) {
		return error;
	}
