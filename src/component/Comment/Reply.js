              ...
              <div className="comment" style={{
                ...
                <div className="comment--body">
                  <div className="d-flex flex-column justify-content-between">
                    <span className="username mb-4 mt-1" style={{ color: "#3B71CA", fontFamily: "Verdana,Arial,sans-serif", fontWeight: "600", fontSize: "18px" }}>
                      {commentData?.user?.userName} <span style={{color: "rgb(70, 58, 58)", fontFamily: "Verdana,Arial,sans-serif", fontsize:"15px", fontWeight:"400"}}><i>wrote:</i></span>
                    </span>
                    {commentContent()}
                  </div>
                  {editing && (
