              ...
              {filteredSpaForumData.map((currentValue) => (
                <>
                  <MDBRow style={{ padding: "1.5% 1%", paddingTop: 0 }}>
                      ...
                      <MDBCol md={2} className="right plr-0 col-6">
                        <p>
                          <b className="commentCount">
                            {/* {currentValue?.spacomments?.length}  */}
                    ...
                    <MDBRow>
                      <MDBCol md={6}>
                        <span className="daytime"> <TimeSinceCreation createdAt={currentValue.createdAt} /></span>{" "}
                        &nbsp;&nbsp;&nbsp;
                        <span
                          // to="/masseuse-thread"
                          // state={{
                          ...
                          onClick={() => handleForum(currentValue)}
                        >
                          <img src={commentIcon} className="chatIcon" alt="comment icon" />
                        </span>
                      </MDBCol>
                    </MDBRow>
