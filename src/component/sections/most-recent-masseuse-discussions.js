                  ...
                  <MDBRow className="mostRecentDiscussion-div">
                    ...
                    <MDBRow>
                      ...
                      <MDBCol md={2} className="right plr-0 col-6">
                        <NavLink state={{ singleSpa: currentValue._source.payload.masseuse }}
                          to={"/single-masseuse?id=" + currentValue._source.payload.masseuse.masseuseId}
                    ...
                    {/* <MDBRow>
											{currentValue._source.payload.masseuse.replies !== [] && (
												<ReplyContainer
													key={currentValue._source.payload.masseuse.replies.id}
													commentData={currentValue._source.payload.masseuse.replies}
